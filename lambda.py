...
<div class="container">
    ...
    <ul>
        <li class="f_row"><span class="moscow" data="Moscow">MOW  </span>
            ...
            <span class="san" data="San Francisco">SFO</span>
        </li>
        <li class="s_row"><span class="flight" data="Flight">SU106</span><span class="seat" data="Seat">13</span><span
                class="gate" data="Gate">37</span></li>
        <li class="t_row"><span class="date" data="Date">26 NOV</span><span class="boarding"
                                                                            data="Boarding">22:09</span></li>
